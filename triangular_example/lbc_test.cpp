...
//    std::cout << "LBC: " << avg << "," << duration1 << ",\n";
    ...
    double ser_time, lvl_time, lbc_time;

    auto *medians = new double[iterNo]();
#ifdef CSC_SER
    //***************Serial
...
//            std::cout << duration1 << ",";
    ...
    ser_time = get_median(medians, iterNo);
//    cout << "\n";
#endif
#ifdef CSC_LVL
    //****************Parallel CSC
...
//            std::cout << duration2 << ",";
    ...
    lvl_time = get_median(medians, iterNo);
//    cout << levels << "\n";
#endif
#ifdef CSC_LBC
    //****************Parallel H2 CSC
...
//            std::cout << duration2 << ",";
    ...
    lbc_time = get_median(medians, iterNo);
//    cout << nLevels << "\n";
#endif
    if(lbc_time <= ser_time)
        std::cout << chunk << " " << innerPart << " " << levelParam << " " << blasThreads << " " << divRate  << "\n";
